    ...
    <center>
        <div class="card">
          <br><br><br><br>
              ...
              <br>
              <font size="5"><b>Consulta:</b> Desde: <?php echo $desde; ?> Hasta: <?php echo $hasta; ?></font>
              ...
              <table width="100%">
                ...
                <?php 
                  if ($kind=='1') {
                    $sql = ("SELECT * FROM factura WHERE estatus='2' AND fecha_entrega>='$desde' AND fecha_entrega<='$hasta'");
                  }elseif ($kind=='2') {
                    $sql = ("SELECT * FROM factura WHERE estatus='2' AND id_registro='$id' AND fecha_entrega>='$desde' AND fecha_entrega<='$hasta'");
                  }
