    ...
    <center>
        <div class="card">
          <center><br><br><br><br>
              ...
              if ($msj == 'adios') {?>
                <center>
                  <font color="green" size="4"><b>Gracias por Visitar Nuestra WEB - Esperamos Regreses Pronto</b></font>
                </center>
              <?php } ?>
              ...
              if ($msj == 'info') {?>
                <center>
                  <font color="green" size="4"><b>Debes Iniciar Sesión para Agregar Productos al Carrito</b></font>
                </center>
              <?php } ?>
